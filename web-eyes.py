...
USAGE = f""" {GREEN}|{DEFAULT} URL:
 ...
 {GREEN}| |{DEFAULT} RIPLOOK: RIPLOOK [DOMAIN, IP] {GREEN}=>{DEFAULT} RIPLOOK [https://example.com, 1.1.1.1]
...
def RIPLOOK(CMD):
    ...
    try:
        ...
        print(f" [{GREEN}INFO{DEFAULT}] RIPLOOK [DOMAIN, IP] {GREEN}=>{DEFAULT} RIPLOOK [https://example.com, 1.1.1.1]")
        return MAIN()
